...
const useValidPhone = (input: any) => {
    ...
    function onPhonePaste(e: ChangeEvent<HTMLInputElement> & ClipboardEvent | any) {
        let input = e.target,
    ...
    function onPhoneInput(e: ChangeEvent<HTMLInputElement> & MessageEvent | any) {
        let input = e.target,
            inputNumbersValue = getInputNumbersValue(input),
        ...
        if (firstNumbers.indexOf(inputNumbersValue[0]) > -1) {
            ...
            formattedInputValue = '+' + inputNumbersValue.substring(0, inputNumbersValue.length)
        }
    ...
    function onPhoneKeyDown(e: ChangeEvent<HTMLInputElement> & KeyboardEvent | any) {
